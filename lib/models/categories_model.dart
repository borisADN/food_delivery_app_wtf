...
List<Category> myCategories = [
  Category(image: 'assets/images/burger.png', name: 'Burger'),
  Category(image: 'assets/images/cup_cake.png', name: 'Cup Cake'),
  Category(image: 'assets/images/pizza.png', name: 'Pizza'),
];
//
